...
sealed interface MsgpackWriterOperator permits MsgpackWriterArrayOperator, MsgpackWriterMapOperator {
	...
	///
	/// @param operator A consumer that accepts a [MessagePacker] instance to
	...
	/// Extension of [Consumer] consuming a packer instance but allowing for [IOException]
	/// to be automatically caught in the method signature and wrapped in a [JsonIoException].
	///
	/// @since 1.0
