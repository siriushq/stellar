...
public class MessageBuffer
{
    ...
    private static final String UNIVERSAL_MESSAGE_BUFFER = "sirius.stellar.serialization.msgpack.buffer.MessageBufferU";
    private static final String BIGENDIAN_MESSAGE_BUFFER = "sirius.stellar.serialization.msgpack.buffer.MessageBufferBE";
    private static final String DEFAULT_MESSAGE_BUFFER = "sirius.stellar.serialization.msgpack.buffer.MessageBuffer";
    ...
    {
        if (offset == 0 && length == size()) return this;
		if (offset + length > size()) throw new IllegalArgumentException();
