...
///
/// This enumerator offers a "fluent" syntax for obtaining a [TerminalConstant] for any
/// given value to allow a large amount of customization to the output colors.
///
/// [TerminalColor#DEFAULT] is a special case in this enumerator as it does not differ
...
public enum TerminalColor {
	...
	public static class TerminalColorScoped {
		...
		/// This can then be output to any supported environment using [#toString()].
		///
